...
const PROJECTED_LINEUPS = {
  ...
  'Qatar':               { formation:'4-3-3',    xi:['Meshaal Barsham', 'Ayoub Al-Alawi', 'Boualem Khoukhi', 'Pedro Miguel', 'Homam Al-Amin', 'Karim Boudiaf', 'Ahmed Fathi', 'Issa Laye', 'Edmilson Junior', 'Almoez Ali', 'Akram Afif'] },
  'Brazil':              { formation:'4-3-3',    xi:['Alisson', 'Wesley', 'Marquinhos', 'Gabriel', 'Douglas Santos', 'Bruno Guimaraes', 'Casemiro', 'Lucas Paqueta', 'Raphinha', 'Vinicius Junior', 'Matheus Cunha'] },
  ...
  'Türkiye':             { formation:'4-2-3-1',  xi:['Ugurcan Cakir', 'Zeki Celik', 'Merih Demiral', 'Abdulkerim Bardakci', 'Ferdi Kadioglu', 'Hakan Calhanoglu', 'Salih Ozcan', 'Arda Guler', 'Kenan Yildiz', 'Baris Alper Yilmaz', 'Deniz Gul'] },
  ...
  'Ecuador':             { formation:'4-3-3',    xi:['Hernan Galindez', 'Angelo Preciado', 'Willian Pacho', 'Piero Hincapie', 'Pervis Estupinan', 'Moises Caicedo', 'Alan Franco', 'Kendry Paez', 'Gonzalo Plata', 'Enner Valencia', 'Nilson Angulo'] },
  ...
  'Sweden':              { formation:'3-4-2-1',  xi:['Kristoffer Nordfeldt', 'Isak Hien', 'Gustaf Lagerbielke', 'Victor Lindelof', 'Daniel Svensson', 'Yasin Ayari', 'Jesper Karlstrom', 'Gabriel Gudmundsson', 'Anthony Elanga', 'Viktor Gyokeres', 'Alexander Isak'] },
  ...
  'Spain':               { formation:'4-3-3',    xi:['Unai Simon', 'Pedro Porro', 'Pau Cubarsi', 'Aymeric Laporte', 'Marc Cucurella', 'Rodri', 'Pedri', 'Mikel Merino', 'Ferran Torres', 'Mikel Oyarzabal', 'Dani Olmo'] },
  ...
  'Norway':              { formation:'4-3-3',    xi:['Orjan Nyland', 'Julian Ryerson', 'Kristoffer Ajer', 'Torbjorn Heggem', 'David Moller Wolfe', 'Sander Berge', 'Martin Odegaard', 'Fredrik Aursnes', 'Antonio Nusa', 'Erling Haaland', 'Alexander Sorloth'] },
  'France':              { formation:'4-3-3',    xi:['Mike Maignan', 'Jules Kounde', 'Ibrahima Konate', 'Dayot Upamecano', 'Theo Hernandez', 'Aurelien Tchouameni', 'Adrien Rabiot', 'Warren Zaire-Emery', 'Ousmane Dembele', 'Kylian Mbappe', 'Michael Olise'] },
  'Senegal':             { formation:'4-3-3',    xi:['Edouard Mendy', 'Krepin Diatta', 'Kalidou Koulibaly', 'Moussa Niakhate', 'Ismail Jakobs', 'Idrissa Gana Gueye', 'Pape Matar Sarr', 'Lamine Camara', 'Sadio Mane', 'Nicolas Jackson', 'Iliman Ndiaye'] },
  ...
  'Argentina':           { formation:'4-3-3',    xi:['Emiliano Martinez', 'Nahuel Molina', 'Cristian Romero', 'Nicolas Otamendi', 'Nicolas Tagliafico', 'Rodrigo De Paul', 'Enzo Fernandez', 'Alexis Mac Allister', 'Lionel Messi', 'Julian Alvarez', 'Lautaro Martinez'] },
  ...
  'Jordan':              { formation:'4-2-3-1',  xi:['Yazid Abulaila', 'Yazan Al Arab', 'Ehsan Haddad', 'Abdallah Nasib', 'Saleem Obaid', 'Nizar Al Rashdan', 'Mohannad Abu Taha', 'Noor Al Rawabdeh', 'Mousa Al Tamari', 'Odeh Al-Fakhouri', 'Ali Olwan'] },
  ...
  'DR Congo':            { formation:'4-3-3',    xi:['Lionel Mpasi', 'Aaron Wan-Bissaka', 'Chancel Mbemba', 'Axel Tuanzebe', 'Arthur Masuaku', 'Noah Sadiki', 'Edo Kayembe', 'Samuel Moutoussamy', 'Yoane Wissa', 'Cedric Bakambu', 'Theo Bongonda'] },
...
// Last full review of all 48 projected XIs against final pre-tournament friendlies
